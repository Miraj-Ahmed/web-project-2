...
<head>
	...
	<title>Payment Tracker || Monthwise Payment Report</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Monthwise Payment Report</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Monthwise Payment Report</div>
...
?>
<h5 align="center" style="color:blue">Monthwise Payment Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
<hr />
