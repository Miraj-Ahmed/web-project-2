...
<script>
	...
	$('#new_fees').click(function(){
		uni_modal("Enroll User ","manage_fee.php","mid-large")
		
	})
	$('.edit_fees').click(function(){
		uni_modal("Manage User's Enrollment Details","manage_fee.php?id="+$(this).attr('data-id'),"mid-large")
		
	})
	$('.delete_fees').click(function(){
		_conf("Are you sure to delete this Payment ?","delete_fees",[$(this).attr('data-id')])
	})
