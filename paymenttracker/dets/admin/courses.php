						...
						<table class="table table-condensed table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="">Share/Id</th>
									<th class="">Description</th>
									<th class="">Total Amont</th>
...
<script>
	...
	$('#new_course').click(function(){
		uni_modal("New Share and Payment Entry","manage_course.php",'large')
		
	})

	$('.edit_course').click(function(){
		uni_modal("Manage Share and Payment Entry","manage_course.php?id="+$(this).attr('data-id'),'large')
		
	})
	$('.delete_course').click(function(){
		_conf("Are you sure to delete this Share?","delete_course",[$(this).attr('data-id')])
	})
