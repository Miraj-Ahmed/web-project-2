...
<script>
	...
	$('#new_student').click(function(){
		uni_modal("New User ","manage_student.php","mid-large")
		
	})
	$('.edit_student').click(function(){
		uni_modal("Manage User Details","manage_student.php?id="+$(this).attr('data-id'),"mid-large")
		
	})
	$('.delete_student').click(function(){
		_conf("Are you sure to delete this User ?","delete_student",[$(this).attr('data-id')])
	})
